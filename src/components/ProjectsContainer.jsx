...
const images = [
  ...
  { id: 4, imagem: image4, text: "Um site React que permite explorar e descobrir filmes de forma simples. Com integração à API do The Movie Database (TMDB), oferecemos uma vasta biblioteca de informações sobre filmes, incluindo sinopse, elenco e classificações.", link: '#' },
];
